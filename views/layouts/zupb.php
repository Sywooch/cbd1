...
use app\assets\ZupbAsset;


ZupbAsset::register($this);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
...
//                                'template' => '<a class="btn btn-primary btn-lg ml-2 mr-2" href="{url}" title="{label}"><span class="badge-message"><img src="/zupb/images/icon-chat.png">' . $messages_counter . '</span></a>',
//                                'url' => ['/messages/index'],
//                                'visible' => !Yii::$app->user->isGuest,
//                                'options' => [
//                                    'class' => 'nav-item',
...
//                                'template' => '<a class="btn btn-primary btn-lg badge-profile nav-link dropdown-toggle" href="#" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><img src="/zupb/images/icon-profile.png"></a>',
//                                'items' => $items,
...
<!-- menu with socials -->
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-primary site-navigate d-none d-lg-flex">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bottom-menu">
            ...
            <ul class="navbar-nav ml-auto social">
                <li class="nav-item">
                    <a class="nav-link social-vk" href="#">
                        <!-- <img src="/zupb/images/vk.png" alt="vk"> -->
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link social-fb" href="#">
                        <!-- <img src="/zupb/images/fb.png" alt="fb"> -->
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link social-gplus" href="#">
                        <!-- <img src="/zupb/images/g+.png" alt="gplus"> -->
                    </a>
                </li>
            </ul>
        </div>
