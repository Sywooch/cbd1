            ...
            <div class="row no-gutters">
                        ...
                        <div class="col-12 how-it-works-list-item">
                            <div class="row">
                                ...
                                <div class="col-md-9 how-it-works-list-description">
                                    <p>Ліквідатор публікує оголошення, яке містить опис активу (майна), початкову ціну, умови участі, розмір гарантійного внеску та іншу інформацію.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 how-it-works-list-item">
                ...
                <aside class="d-none d-lg-block col-lg-4">
                    <div class="register-block text-center text-lg-left">
                        ...
                        <a href="#" class="btn btn-primary btn-block">Реєстрація Ліквідатора</a>
                    </div>
                </aside>
            </div>
        </div>
