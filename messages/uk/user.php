...
return [
    ...
    'If you did not make this request you can ignore this email' => 'Рішення щодо надання доступу до особистого кабінету буде прийнято адміністратором майданчика',//'P.S. Якщо ви отримали це повідомлення про помилку, просто видаліть його',
    ...
    'Your account has been created and a message with further instructions has been sent to your email' => 'Обліковий запис було створено та повідомлення з подальшими інструкціями відіслано на вашу електронну пошту',
];
